...
# 全局下载地址配置
DOCKER_COMPOSEV4_URL="https://github.com/qiyeb/flux-panel/releases/download/last/docker-compose-v4.yml"
DOCKER_COMPOSEV6_URL="https://github.com/qiyeb/flux-panel/releases/download/last/docker-compose-v6.yml"
